...
public class EntitySQLMetaDataImpl implements EntitySQLMetaData {
    ...
    public String getSelectByIdSql() {
        ...
        if (id == null) {
            throw new ValidationException("No field with Id annotation");
        }
    ...
    public String getInsertSql() {
        List<String> fields = metaData.getFieldsWithoutId()
                .stream()
                .map(Field::getName)
                .toList();
        ...
        return "INSERT into " + metaData.getName() + " (" + String.join(", ", fields) + ") "
                + "VALUES (" + values + ")";
    }
    ...
    public String getUpdateSql() {
        ...
        String values = metaData.getFieldsWithoutId()
                .stream()
                .map(Field::getName)
                .map(f -> f + " = ?,")
