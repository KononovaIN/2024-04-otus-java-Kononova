...
public class AppComponentsContainerImpl implements AppComponentsContainer {
    ...
    private void processConfig(Class<?>... initialConfigClass) {
        ...
        for (var configClass : classes) {
            ...
            try {
                Object instance = getInstanse(configClass);
    ...
    public <C> C getAppComponent(Class<C> componentClass) {
        List<Object> collect = appComponents.stream()
    ...
    private Object getInstanse(Class<?> configClass) throws InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchMethodException {
    ...
    private List<Method> sortedMethodsByOrder(Method[] methods) {
        return Arrays.stream(methods)
                ...
                .sorted((Comparator.comparingInt(o -> o.getDeclaredAnnotation(AppComponent.class).order())))
                .toList();
    }
    ...
    private Object[] getArgsForBean(Class<?>[] parameters) {
        ...
        Arrays.stream(parameters)
                .forEach(p -> args.add(getAppComponent(p)));
